...
3. Start RStudio. Select **File -> Open project...** and navigate to the RStudio project you created in the first practical session. This should be a file called NES2504; open it and check that `NES2504` is showing in the top right corner of the RStudio window.
...
## Interpretation
How might you write up these results in a report? Compare your ANOVA and Tukey results to your boxplot. Also look at the NES2504 Course Handbook and its last section on report-writing.
