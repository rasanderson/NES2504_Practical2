...
3. Start RStudio. Select **File -> Recent projects -> NES2303** to open up the RStudio project you created in the first practical session. Check that `NES2303` is showing in the top right corner of the RStudio window.
